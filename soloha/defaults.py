...
SHOP_NAME = 'Oscar'
SHOP_TAGLINE = ''
HOMEPAGE = reverse_lazy('promotions:home')
...
# Copy this image from soloha/static/img to your MEDIA_ROOT folder.
...
PROMOTION_MERCHANDISING_BLOCK_TYPES = (
...
# Alternatively, the management command ``soloha_send_alerts`` can be used to
...
FROM_EMAIL = 'soloha@example.com'

# Slug handling
SLUG_FUNCTION = 'soloha.core.utils.default_slugifier'
SLUG_MAP = {}
SLUG_BLACKLIST = []

# Cookies
COOKIES_DELETE_ON_LOGOUT = ['recently_viewed_products', ]
