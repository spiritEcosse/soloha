...
class Test(object):
    ...
    def create_feature(self):
        ...
        feature_11, created = Feature.objects.get_or_create(title='Feature 11', parent=feature_1)
        feature_2, created = Feature.objects.get_or_create(title='Feature 2')
        feature_21, created = Feature.objects.get_or_create(title='Feature 21', parent=feature_2)
        feature_22, created = Feature.objects.get_or_create(title='Feature 22', parent=feature_2)
        feature_23, created = Feature.objects.get_or_create(title='Feature 23', parent=feature_2)
        feature_211, created = Feature.objects.get_or_create(title='Feature 211', parent=feature_21)
        feature_3, created = Feature.objects.get_or_create(title='Feature 3')
        feature_31, created = Feature.objects.get_or_create(title='Feature 31', parent=feature_3)
        feature_32, created = Feature.objects.get_or_create(title='Feature 32', parent=feature_3)
        feature_33, created = Feature.objects.get_or_create(title='Feature 33', parent=feature_3)
    ...
    def create_attributes(self, product):
        ...
        feature_22, created = Feature.objects.get_or_create(title='Feature 22')
        feature_23, created = Feature.objects.get_or_create(title='Feature 23')
        feature_31, created = Feature.objects.get_or_create(title='Feature 31')
        feature_32, created = Feature.objects.get_or_create(title='Feature 32')
        feature_33, created = Feature.objects.get_or_create(title='Feature 33')
