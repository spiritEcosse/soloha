...
from soloha.core.views.generic import PostActionMixin
from soloha.core.compat import get_user_model
from soloha.core.loading import get_profile_class

from apps.customer.utils import get_password_reset_url, Dispatcher
from apps.customer import signals
from apps.customer.mixins import PageTitleMixin, RegisterUserMixin
from apps.customer.models import Email, CommunicationEventType
from apps.customer.forms import EmailAuthenticationForm, EmailUserCreationForm, OrderSearchForm, PasswordChangeForm, \
    ProfileForm, ConfirmPasswordForm
from apps.address.forms import UserAddressForm
