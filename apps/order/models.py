...
class QuickOrder(models.Model):
    ...
    phone_number = models.CharField(verbose_name=_('Phone number client'), max_length=19)
...
class LineAttribute(models.Model):
    ...
    option = models.ForeignKey(
        'catalogue.Option', null=True, blank=True, on_delete=models.SET_NULL, related_name="line_attributes",
        verbose_name=_("Option")
    )
    type = models.CharField(_("Type"), blank=True, max_length=128)
    value = models.CharField(_("Value"), blank=True, max_length=255)
...
class OrderDiscount(models.Model):
    ...
    def offer(self):
        ...
        try:
            return ConditionalOffer.objects.get(id=self.offer_id)
