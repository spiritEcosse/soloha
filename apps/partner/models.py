...
@python_2_unicode_compatible
class StockRecord(models.Model, CommonFeatureProduct):
    """
    A stock record.
    ...
    partner = models.ForeignKey(Partner, verbose_name=_("Partner"),related_name='stockrecords', null=True, blank=True)
...
class StockAlert(models.Model):
    ...
    """
    stockrecord = models.ForeignKey(StockRecord, related_name='alerts', verbose_name=_("Stock Record"))
