...
class CatalogueImporter(object):
    ...
    def _create_item(self, product_class, category_str, upc, title,
        ...
        # Category
        # Todo replace ProductCategory on categories from Product if needed
