...
from apps.search.signals import user_search
from apps.analytics.models import UserSearch, UserRecord, ProductRecord, UserProductView
from apps.catalogue.signals import product_viewed
from apps.basket.signals import basket_addition
from apps.order.signals import order_placed
