...
class ProductRecord(models.Model):
    ...
    product = models.OneToOneField(Product, verbose_name=_("Product"), related_name='stats')

    # Data used for generating a score
    num_views = models.PositiveIntegerField(_('Views'), default=0, db_index=True)
    num_basket_additions = models.PositiveIntegerField(_('Basket Additions'), default=0, db_index=True)
    num_purchases = models.PositiveIntegerField(_('Purchases'), default=0, db_index=True)
...
class UserRecord(models.Model):
    ...
    # Browsing stats
    num_product_views = models.PositiveIntegerField(_('Product Views'), default=0, db_index=True)
    num_basket_additions = models.PositiveIntegerField(_('Basket Additions'), default=0, db_index=True)
    ...
    total_spent = models.DecimalField(
        _('Total Spent'), decimal_places=2, max_digits=12, default=Decimal('0.00'), db_index=True
    )
    date_last_order = models.DateTimeField(_('Last Order Date'), blank=True, null=True, db_index=True)
