...
@override_settings(soloha_ALLOW_ANON_CHECKOUT=True)
...
class TestShippingMethodView(CheckoutMixin, WebTestCase):
    ...
    @mock.patch('apps.checkout.views.Repository')
...
class TestPaymentDetailsView(CheckoutMixin, WebTestCase):
    ...
    @mock.patch('apps.checkout.views.PaymentDetailsView.handle_payment')
    ...
    @mock.patch('apps.checkout.views.logger')
    @mock.patch('apps.checkout.views.PaymentDetailsView.handle_payment')
    ...
    @mock.patch('apps.checkout.views.logger')
    @mock.patch('apps.checkout.views.PaymentDetailsView.handle_order_placement')
